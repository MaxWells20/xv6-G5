...
_traduccion:     file format elf32-i386
...
int main(int argc,char *argv[])
{
  ...
  32:	e8 f9 03 00 00       	call   430 <printf>
    printf(1,"\n Status from system call: %s",translate());
  37:	e8 2f 03 00 00       	call   36b <translate>
  3c:	83 c4 0c             	add    $0xc,%esp
  3f:	50                   	push   %eax
  40:	68 d7 07 00 00       	push   $0x7d7
  45:	6a 01                	push   $0x1
  47:	e8 e4 03 00 00       	call   430 <printf>
    exit();
  4c:	e8 72 02 00 00       	call   2c3 <exit>
  51:	66 90                	xchg   %ax,%ax
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 fc 07 00 00 	movzbl 0x7fc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb f5 07 00 00       	mov    $0x7f5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 a8 0a 00 00       	mov    0xaa8,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 a8 0a 00 00       	mov    %eax,0xaa8
}
